...
\begin{document}
\frontmatter 
    \include{./Cover/cover} 			% Titelblatt
    \newpage
...
\mainmatter 							% die einzelnen Chapters
    ...
    \input{./Chapters/5_the_rapado_project}
    \input{./Chapters/6_zero_knowledge_proofs}
    \clearpage{\pagestyle{empty}\cleardoublepage}
...
\input{./Chapters/statutory_declaration} % Eidesstattliche Erklärung (nicht bei Seminararb.)
