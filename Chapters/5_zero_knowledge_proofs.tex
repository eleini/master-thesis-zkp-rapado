...
\begin{itemize}
    \item IPs, PCPs, and IOPs are defined. Through the combination of polynomial commitment schemes, argument systems can be designed. Non-interactivity is achieved through the Fiat-Shamir transformation.
