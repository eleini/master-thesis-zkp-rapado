...
\begin{table}[!]
	\centering
		...
		\hline
		\textbf{Application Domain} & \textbf{Selective Literature Overview}\\ \hline
            Identity Management & electronic government, self-sovereign identity and authentication, online auctions, cloud computing\\ \hline
            Data Sharing, Traceability & CircuitTree, digital healthcare, online auctions, ERP Systems, \\ \hline 
            System scaling, protocol enhancement & PipeZK, Cuproof, bulletproof+, transaction verification, quantum security, Sonic, QuickSilver, Ethereum scaling with zkSync and zkRollups \\  \hline        
	\end{tabular}
\label{tab:domains}
\end{table}
...
-yang yang et al
-salleras et al
    - Bonsad et al use case decentralized identity for nationality
