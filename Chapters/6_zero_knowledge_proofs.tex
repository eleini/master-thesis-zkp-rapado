...
FFT
Bilinear Maps Thaler S.231

\begin{comment}

3.FFT def
4. generic group model
5. gen, prove and ver algorithm from QAP
...
1) definitions:
- FFT, KEA knowledge of exponent assumption

- trusted setup, CRS, toxic waste: 


- Elliptic Curve Pairing: - Benamara: ECs and pairings source

2)main functionalities: Gro16 paper also
- trusted setup, proof and verify-->BENAMARA, Guo et al: QAP, Bilinear Maps, R1CS theory
