...
\begin{comment}
-Thaler simulator zero knowledge definition
-indistinguishable: Thaler
- statistical (proofs) and computaional (arguments) soundness
- 3 types of zero-knwoledge: perfect, statistical and computational
- so with honest verifier assumption at least 6 types of protocols: Eleanor Birrell and Salil Vadhan. Composition of zero-knowledge proofs with efficient
provers. In Theory of Cryptography Conference, pages 572–587. Springer, 2010. 172
